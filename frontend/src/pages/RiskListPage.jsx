...
const PAGE_SIZE = 50;
const DEFAULT = { min_score: undefined, derived_category: undefined, state: undefined, status: undefined, offset: 0 };
  ...
  return (
    <div className="space-y-4">
      ...
      {status === "success" && data.items.length === 0 && (
        <Empty>No projects match these filters. Try lowering the minimum score.</Empty>
      )}
